...
const List = () => {
  return (
    ...
    <div className='flex flex-col w-full group items-center mb-4 transition-all relative '>
      ...
      href="https://github.com/Rizqifajri">Github
      <GrGithub/>
      </a>
      ...
      href="https://www.linkedin.com/in/muhammad-rizqi-fajri-0759a222b/">Linkedn
      <GrLinkedinOption/>
      </a>
      ...
      href="https://www.instagram.com/rizqifajriii/">Instagram
      <GrInstagram/>
